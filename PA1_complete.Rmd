...
```
* Mean: `r mean_dailysteps`
* Median: `r median_dailysteps`
...
```
* Which 5-minute interval, on average across all the days in the dataset, contains the maximum number of steps?: `r most.steps`
